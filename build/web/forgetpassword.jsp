<%-- 
    ...
    Created on : 12 Jul, 2018, 3:06:01 AM
    Author     : rohan
--%>
                ...
                <div class="bg-agile">
                    ...
                    <div class="login-form">	
                        <form action="forgot_password" method="post">
                            <input type="email"  name="email" placeholder="Accosiated E-mail address" required="" />		
                            <input type="submit" value="Find"> 
                        </form>
                        <br>
                        <a href="jsp_signup.jsp"><p style="text-align:center">Don't have an ACCOUNT ?</p></a>
